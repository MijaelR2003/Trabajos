...
void matriz9();
void matriz10();
void Amatriz(int matriz[][N], int tam);
int determinante(int matriz[][N], int tam);
int cofactor(int matriz[][N], int tam, int filas, int columnas);
void proyfun();
void ejercicio1();
void ejercicio2 ();
   ...
   while (tam < 0 || tam > N)
    {
        if (tam <= 2)
            ...
            {
               cout << "El tamaño de la matriz no puede ser mayor que " << N << endl;
               cout << "Ingrese nuevamente el tamaño de la matriz: ";
               cin >> tam;
            }
